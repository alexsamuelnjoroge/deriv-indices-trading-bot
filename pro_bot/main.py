...
from pro_bot.strategies.etp              import ETPStrategy
from pro_bot.strategies.nrf              import NRFStrategy
from pro_bot.strategies.mrr              import MRRStrategy
...
_RESEARCH_STRATEGIES = {
    ...
    "cbve", "crd", "vrt", "crw", "shp", "etp", "nrf", "mrr",
}
